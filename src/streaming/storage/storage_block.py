"""src/streaming/storage/storage_block.py.
...
This module creates two DuckDB tables:
  - block_valid_sales: records that passed all validation checks
  - block_rejected_sales: records that failed, with error details attached
...
VALID_TABLE_NAME: Final[str] = "block_valid_sales"
REJECTED_TABLE_NAME: Final[str] = "block_rejected_sales"
