"""src/streaming/kafka_consumer_block.py.
...
from streaming.data_validation.data_contract_block import (
    CONSUMED_FIELDNAMES,
    SALES_REQUIRED_FIELDS,
    validate_required_fields,
)
from streaming.storage.storage_block import init_db, write_valid_record
...
OUTPUT_CSV: Final[Path] = OUTPUT_DIR / "consumed_sales_block.csv"
OUTPUT_DB: Final[Path] = OUTPUT_DIR / "sales_block.duckdb"
...
def process_message(
    ...
    *,
    ...
    enriched["is_high_value"] = "true" if enriched["total"] > 100.0 else "false"
